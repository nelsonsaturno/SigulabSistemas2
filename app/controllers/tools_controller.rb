class ToolsController < ApplicationController
  ...
  private
    ...
    def tool_params
      params.require(:tool).permit(:name, :brand, :type, :national_good, :status, :use, :responsible, :location, :material, :bill, :from_set, :investigation, :teaching, :extention, :management)
    end
end
