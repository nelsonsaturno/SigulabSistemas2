...
class RequisitionsControllerTest < ActionController::TestCase
  ...
  test "should create requisition" do
    assert_difference('Requisition.count') do
      post :create, requisition: { autor: @requisition.autor, consumidor: @requisition.consumidor, observacion: @requisition.observacion, partida: @requisition.partida, solicitante: @requisition.solicitante }
    end
  ...
  test "should update requisition" do
    patch :update, id: @requisition, requisition: { autor: @requisition.autor, consumidor: @requisition.consumidor, observacion: @requisition.observacion, partida: @requisition.partida, solicitante: @requisition.solicitante }
    assert_redirected_to requisition_path(assigns(:requisition))
  end
